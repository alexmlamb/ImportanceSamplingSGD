...
class EphemeralRedisServer():
    ...
    def start(self):
        ...
        # This returns the port in case we are using an ephemeral port.
        # In this case, we don't even support retrying with different ports,
        # or reading the port from redis-server, but it's a good thing
