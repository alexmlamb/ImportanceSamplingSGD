...
export CONFIG_FILE=${IMPORTANCE_SAMPLING_SGD_ROOT}/integration_distributed_training/config_files/helios/11_alternating_ISSGD_USGD_based_on_07/config_068.py
...
export BOOTSTRAP_FILE=${HOME}/bootstrap_experiment_068
