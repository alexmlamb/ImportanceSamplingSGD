...
# msub ~/Documents/ImportanceSamplingSGD/integration_distributed_training/config_files/helios/15_repeat20x031_smaller_learning_rate/launch_00238.sh
# msub -l depend=51777 ~/Documents/ImportanceSamplingSGD/integration_distributed_training/config_files/helios/15_repeat20x031_smaller_learning_rate/launch_00238.sh


#OUTPUT=`msub ~/Documents/ImportanceSamplingSGD/integration_distributed_training/config_files/helios/15_repeat20x031_smaller_learning_rate/launch_00238.sh`
#OUTPUT=`echo $OUTPUT | tr -d " "`
#echo $OUTPUT

#for i in `seq 2 8`;
#do
#    OUTPUT=`msub -l depend=${OUTPUT} ~/Documents/ImportanceSamplingSGD/integration_distributed_training/config_files/helios/15_repeat20x031_smaller_learning_rate/launch_00238.sh`
#    OUTPUT=`echo $OUTPUT | tr -d " "`
#    echo $OUTPUT
#done
...
export CONFIG_FILE=${IMPORTANCE_SAMPLING_SGD_ROOT}/integration_distributed_training/config_files/helios/15_repeat20x031_smaller_learning_rate/config_00238.py
...
export BOOTSTRAP_FILE=${HOME}/bootstrap_experiment_00238
