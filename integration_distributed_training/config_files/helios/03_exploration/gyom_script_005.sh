...
export CONFIG_FILE=${IMPORTANCE_SAMPLING_SGD_ROOT}/integration_distributed_training/config_files/helios/03_exploration/config_005.py
...
export BOOTSTRAP_FILE=${HOME}/bootstrap_experiment_005
