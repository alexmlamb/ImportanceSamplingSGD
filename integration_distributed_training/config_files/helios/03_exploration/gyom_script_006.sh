...
# msub ~/Documents/ImportanceSamplingSGD/integration_distributed_training/config_files/helios/03_exploration/gyom_script_006.sh
# msub -l depend=51777 ~/Documents/ImportanceSamplingSGD/integration_distributed_training/config_files/helios/03_exploration/gyom_script_006.sh
...
export CONFIG_FILE=${IMPORTANCE_SAMPLING_SGD_ROOT}/integration_distributed_training/config_files/helios/03_exploration/config_006.py
...
export BOOTSTRAP_FILE=${HOME}/bootstrap_experiment_006
