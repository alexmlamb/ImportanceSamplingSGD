...
# msub ~/Documents/ImportanceSamplingSGD/integration_distributed_training/config_files/helios/03_exploration/gyom_script_007.sh
# msub -l depend=51777 ~/Documents/ImportanceSamplingSGD/integration_distributed_training/config_files/helios/03_exploration/gyom_script_007.sh
...
export CONFIG_FILE=${IMPORTANCE_SAMPLING_SGD_ROOT}/integration_distributed_training/config_files/helios/03_exploration/config_007.py
...
export BOOTSTRAP_FILE=${HOME}/bootstrap_experiment_007
