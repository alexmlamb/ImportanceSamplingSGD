...
def get_model_config():
    ...
    model_config["master_routine"] = ["sync_params"] + (["refresh_importance_weights", "process_minibatch"] * 10)
    model_config["worker_routine"] = ["sync_params"] + ["process_minibatch"]
...
def get_database_config():
    ...
    experiment_root_dir = "/rap/jvb-000-aa/data/alaingui/experiments_ISGD/027"
    redis_rdb_path_plus_filename = os.path.join(experiment_root_dir, "027.rdb")
