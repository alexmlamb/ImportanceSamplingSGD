...
export CONFIG_FILE=${IMPORTANCE_SAMPLING_SGD_ROOT}/integration_distributed_training/config_files/helios/06_repro/config_020.py
...
export BOOTSTRAP_FILE=${HOME}/bootstrap_experiment_020
