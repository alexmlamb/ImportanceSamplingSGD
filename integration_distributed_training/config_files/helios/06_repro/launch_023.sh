...
#OUTPUT=`msub ~/Documents/ImportanceSamplingSGD/integration_distributed_training/config_files/helios/06_repro/launch_023.sh`
...
export CONFIG_FILE=${IMPORTANCE_SAMPLING_SGD_ROOT}/integration_distributed_training/config_files/helios/06_repro/config_023.py
...
export BOOTSTRAP_FILE=${HOME}/bootstrap_experiment_023
