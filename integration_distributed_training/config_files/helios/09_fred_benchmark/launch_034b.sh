...
# msub ~/Documents/ImportanceSamplingSGD/integration_distributed_training/config_files/helios/09_fred_benchmark/launch_034b.sh
# msub -l depend=51777 ~/Documents/ImportanceSamplingSGD/integration_distributed_training/config_files/helios/09_fred_benchmark/launch_034b.sh


#OUTPUT=`msub ~/Documents/ImportanceSamplingSGD/integration_distributed_training/config_files/helios/09_fred_benchmark/launch_034b.sh`
#OUTPUT=`echo $OUTPUT | tr -d " "`
#echo $OUTPUT

#for i in `seq 2 8`;
#do
#    OUTPUT=`msub -l depend=${OUTPUT} ~/Documents/ImportanceSamplingSGD/integration_distributed_training/config_files/helios/09_fred_benchmark/launch_034b.sh`
#    OUTPUT=`echo $OUTPUT | tr -d " "`
#    echo $OUTPUT
#done
...
export CONFIG_FILE=${IMPORTANCE_SAMPLING_SGD_ROOT}/integration_distributed_training/config_files/helios/09_fred_benchmark/config_034b.py
...
export BOOTSTRAP_FILE=${HOME}/bootstrap_experiment_034b
...
THEANO_FLAGS=device=cuda0,floatX=float32 stdbuf -i0 -o0 -e0 python ${IMPORTANCE_SAMPLING_SGD_BIN}/run_master.py --config_file=${CONFIG_FILE} --bootstrap_file=${BOOTSTRAP_FILE} &
THEANO_FLAGS=device=cuda1,floatX=float32 stdbuf -i0 -o0 -e0 python ${IMPORTANCE_SAMPLING_SGD_BIN}/run_worker.py --config_file=${CONFIG_FILE} --bootstrap_file=${BOOTSTRAP_FILE} &
THEANO_FLAGS=device=cuda2,floatX=float32 stdbuf -i0 -o0 -e0 python ${IMPORTANCE_SAMPLING_SGD_BIN}/run_worker.py --config_file=${CONFIG_FILE} --bootstrap_file=${BOOTSTRAP_FILE} &
THEANO_FLAGS=device=cuda3,floatX=float32 stdbuf -i0 -o0 -e0 python ${IMPORTANCE_SAMPLING_SGD_BIN}/run_worker.py --config_file=${CONFIG_FILE} --bootstrap_file=${BOOTSTRAP_FILE} &
