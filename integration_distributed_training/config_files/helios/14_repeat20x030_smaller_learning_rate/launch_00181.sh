...
# msub ~/Documents/ImportanceSamplingSGD/integration_distributed_training/config_files/helios/14_repeat20x030_smaller_learning_rate/launch_00181.sh
# msub -l depend=51777 ~/Documents/ImportanceSamplingSGD/integration_distributed_training/config_files/helios/14_repeat20x030_smaller_learning_rate/launch_00181.sh


#OUTPUT=`msub ~/Documents/ImportanceSamplingSGD/integration_distributed_training/config_files/helios/14_repeat20x030_smaller_learning_rate/launch_00181.sh`
#OUTPUT=`echo $OUTPUT | tr -d " "`
#echo $OUTPUT

#for i in `seq 2 8`;
#do
#    OUTPUT=`msub -l depend=${OUTPUT} ~/Documents/ImportanceSamplingSGD/integration_distributed_training/config_files/helios/14_repeat20x030_smaller_learning_rate/launch_00181.sh`
#    OUTPUT=`echo $OUTPUT | tr -d " "`
#    echo $OUTPUT
#done
...
export CONFIG_FILE=${IMPORTANCE_SAMPLING_SGD_ROOT}/integration_distributed_training/config_files/helios/14_repeat20x030_smaller_learning_rate/config_00181.py
...
export BOOTSTRAP_FILE=${HOME}/bootstrap_experiment_00181
