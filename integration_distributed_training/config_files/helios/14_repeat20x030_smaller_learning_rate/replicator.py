...
LP_patterns = [ (r"(.*)07_paper_again/config_030.py(.*)", "14_repeat20x030_smaller_learning_rate/config_%0.5d.py"),
                ...
                (r"(.*)07_paper_again/launch_030.sh(.*)", "14_repeat20x030_smaller_learning_rate/launch_%0.5d.sh")
                ]
...
for experiment_index in range(experiment_start_index, experiment_start_index + nreps):
    ...
    L_extra_cmds_2.append("msub ~/Documents/ImportanceSamplingSGD/integration_distributed_training/config_files/helios/14_repeat20x030_smaller_learning_rate/launch_%0.5d.sh" % experiment_index)
