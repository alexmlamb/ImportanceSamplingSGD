...
export CONFIG_FILE=${IMPORTANCE_SAMPLING_SGD_ROOT}/integration_distributed_training/config_files/helios/08_paper_again_smaller_learning_rate/config_043.py
...
export BOOTSTRAP_FILE=${HOME}/bootstrap_experiment_043
