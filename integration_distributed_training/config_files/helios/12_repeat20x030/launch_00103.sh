...
# msub -l depend=51777 ~/Documents/ImportanceSamplingSGD/integration_distributed_training/config_files/helios/12_repeat20x030/launch_00103.sh


#OUTPUT=`msub ~/Documents/ImportanceSamplingSGD/integration_distributed_training/config_files/helios/12_repeat20x030/launch_00103.sh`
#OUTPUT=`echo $OUTPUT | tr -d " "`
#echo $OUTPUT

#for i in `seq 2 8`;
#do
#    OUTPUT=`msub -l depend=${OUTPUT} ~/Documents/ImportanceSamplingSGD/integration_distributed_training/config_files/helios/12_repeat20x030/launch_00103.sh`
#    OUTPUT=`echo $OUTPUT | tr -d " "`
#    echo $OUTPUT
#done
...
export CONFIG_FILE=${IMPORTANCE_SAMPLING_SGD_ROOT}/integration_distributed_training/config_files/helios/12_repeat20x030/config_00103.py
...
export BOOTSTRAP_FILE=${HOME}/bootstrap_experiment_00103
