...
# msub ~/Documents/ImportanceSamplingSGD/integration_distributed_training/config_files/helios/04_race/launch_012.sh
# msub -l depend=51777 ~/Documents/ImportanceSamplingSGD/integration_distributed_training/config_files/helios/04_race/launch_012.sh


#OUTPUT=`msub ~/Documents/ImportanceSamplingSGD/integration_distributed_training/config_files/helios/04_race/launch_012.sh`
#OUTPUT=`echo $OUTPUT | tr -d " "`
#echo $OUTPUT

#OUTPUT=`msub -l depend=${OUTPUT} ~/Documents/ImportanceSamplingSGD/integration_distributed_training/config_files/helios/04_race/launch_012.sh`
#OUTPUT=`echo $OUTPUT | tr -d " "`
#echo $OUTPUT
...
export CONFIG_FILE=${IMPORTANCE_SAMPLING_SGD_ROOT}/integration_distributed_training/config_files/helios/04_race/config_012.py
...
export BOOTSTRAP_FILE=${HOME}/bootstrap_experiment_012
