...
def get_model_config():
    ...
    model_config["momentum_rate"] = 0.8
...
def get_database_config():
    ...
    experiment_root_dir = "/rap/jvb-000-aa/data/alaingui/experiments_ISGD/013"
    redis_rdb_path_plus_filename = os.path.join(experiment_root_dir, "013.rdb")
