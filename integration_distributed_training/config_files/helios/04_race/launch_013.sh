...
# msub ~/Documents/ImportanceSamplingSGD/integration_distributed_training/config_files/helios/04_race/launch_013.sh
...
export CONFIG_FILE=${IMPORTANCE_SAMPLING_SGD_ROOT}/integration_distributed_training/config_files/helios/04_race/config_013.py
...
export BOOTSTRAP_FILE=${HOME}/bootstrap_experiment_013
