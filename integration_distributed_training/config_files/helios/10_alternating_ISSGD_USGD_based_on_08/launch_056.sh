...
export CONFIG_FILE=${IMPORTANCE_SAMPLING_SGD_ROOT}/integration_distributed_training/config_files/helios/10_alternating_ISSGD_USGD_based_on_08/config_056.py
...
export BOOTSTRAP_FILE=${HOME}/bootstrap_experiment_056
