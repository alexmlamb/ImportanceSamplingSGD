...
export CONFIG_FILE=${IMPORTANCE_SAMPLING_SGD_ROOT}/integration_distributed_training/config_files/helios/07_paper_again/config_035.py
...
export BOOTSTRAP_FILE=${HOME}/bootstrap_experiment_035
