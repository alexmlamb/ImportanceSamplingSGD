...
# msub ~/Documents/ImportanceSamplingSGD/integration_distributed_training/config_files/helios/02_together/gyom_script_003.sh
# msub -l depend=51777 ~/Documents/ImportanceSamplingSGD/integration_distributed_training/config_files/helios/02_together/gyom_script_003.sh
...
export CONFIG_FILE=${IMPORTANCE_SAMPLING_SGD_ROOT}/integration_distributed_training/config_files/helios/02_together/config_003.py
...
export BOOTSTRAP_FILE=${HOME}/bootstrap_experiment_003
