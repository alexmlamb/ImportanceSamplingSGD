...
export CONFIG_FILE=${IMPORTANCE_SAMPLING_SGD_ROOT}/integration_distributed_training/config_files/helios/13_repeat20x031/config_00161.py
...
export BOOTSTRAP_FILE=${HOME}/bootstrap_experiment_00161
