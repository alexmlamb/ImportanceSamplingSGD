...
LP_patterns = [ (r"(.*)07_paper_again/config_031.py(.*)", "13_repeat20x031/config_%0.5d.py"),
                ...
                (r"(.*)07_paper_again/launch_031.sh(.*)", "13_repeat20x031/launch_%0.5d.sh")
                ]
...
for experiment_index in range(experiment_start_index, experiment_start_index + nreps):
    ...
    L_extra_cmds_2.append("msub ~/Documents/ImportanceSamplingSGD/integration_distributed_training/config_files/helios/13_repeat20x031/launch_%0.5d.sh" % experiment_index)
