...
export CONFIG_FILE=${IMPORTANCE_SAMPLING_SGD_ROOT}/integration_distributed_training/config_files/helios/06_rmsprop/config_isgd_adam.py
...
export BOOTSTRAP_FILE=${HOME}/bootstrap_config_isgd_adam
